...
model_fpn = ['fpn-resnet','resnet']
model_darknet ='darknet'
sequence = "1"
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/' + model_fpn[0] + '/results_sequence_' + sequence + '_' + model_fpn[1])
